...
export function seedAllCollections(): void {
  ...
  seed('machines', [
    { id: 'OL-101', name: 'Overlock Machine OL-101', serialNumber: 'SN-OL-A1B2', type: 'Overlock Machine',   location: 'Line 01',      status: 'Running',   lastMaintenanceDate: '2026-01-10', lastInspectionDate: '2026-02-15', usageHistory: 'Normal operation.',         imageUrl: 'https://picsum.photos/seed/OL-101/400/300' },
    { id: 'OL-102', name: 'Overlock Machine OL-102', serialNumber: 'SN-OL-C3D4', type: 'Overlock Machine',   location: 'Line 01',      status: 'Idle',      lastMaintenanceDate: '2026-01-20', lastInspectionDate: '2026-02-20', usageHistory: 'Awaiting batch.',            imageUrl: 'https://picsum.photos/seed/OL-102/400/300' },
    { id: 'OL-103', name: 'Overlock Machine OL-103', serialNumber: 'SN-OL-E5F6', type: 'Overlock Machine',   location: 'Line 02',      status: 'Running',   lastMaintenanceDate: '2026-02-01', lastInspectionDate: '2026-02-28', usageHistory: 'Recently transferred.',     imageUrl: 'https://picsum.photos/seed/OL-103/400/300' },
    { id: 'FL-101', name: 'Flatlock Machine FL-101',  serialNumber: 'SN-FL-G7H8', type: 'Flatlock Machine',  location: 'Line 01',      status: 'Running',   lastMaintenanceDate: '2026-01-15', lastInspectionDate: '2026-02-10', usageHistory: 'Normal operation.',         imageUrl: 'https://picsum.photos/seed/FL-101/400/300' },
    { id: 'FL-102', name: 'Flatlock Machine FL-102',  serialNumber: 'SN-FL-I9J0', type: 'Flatlock Machine',  location: 'Machine Bank', status: 'Bank',      lastMaintenanceDate: '2025-12-05', lastInspectionDate: '2026-01-10', usageHistory: 'In storage.',               imageUrl: 'https://picsum.photos/seed/FL-102/400/300' },
    { id: 'FA-101', name: 'Feed of the Arm FA-101',   serialNumber: 'SN-FA-K1L2', type: 'Feed of the Arm',   location: 'Line 02',      status: 'Running',   lastMaintenanceDate: '2026-01-25', lastInspectionDate: '2026-03-01', usageHistory: 'Normal operation.',         imageUrl: 'https://picsum.photos/seed/FA-101/400/300' },
    { id: 'FA-102', name: 'Feed of the Arm FA-102',   serialNumber: 'SN-FA-M3N4', type: 'Feed of the Arm',   location: 'Machine Bank', status: 'Repair',    lastMaintenanceDate: '2025-11-20', lastInspectionDate: '2026-02-05', usageHistory: 'Feed dog replacement due.', imageUrl: 'https://picsum.photos/seed/FA-102/400/300' },
    { id: 'BT-101', name: 'Bartack Machine BT-101',   serialNumber: 'SN-BT-O5P6', type: 'Bartack Machine',   location: 'Line 03',      status: 'Running',   lastMaintenanceDate: '2026-02-10', lastInspectionDate: '2026-03-05', usageHistory: 'Normal operation.',         imageUrl: 'https://picsum.photos/seed/BT-101/400/300' },
    { id: 'BT-102', name: 'Bartack Machine BT-102',   serialNumber: 'SN-BT-Q7R8', type: 'Bartack Machine',   location: 'Line 03',      status: 'Breakdown', lastMaintenanceDate: '2025-10-15', lastInspectionDate: '2026-01-20', usageHistory: 'Motor failure reported.',   imageUrl: 'https://picsum.photos/seed/BT-102/400/300' },
    { id: 'BH-101', name: 'Buttonhole Machine BH-101',serialNumber: 'SN-BH-S9T0', type: 'Buttonhole Machine',location: 'Line 04',      status: 'Running',   lastMaintenanceDate: '2026-02-20', lastInspectionDate: '2026-03-08', usageHistory: 'Normal operation.',         imageUrl: 'https://picsum.photos/seed/BH-101/400/300' },
    { id: 'BH-102', name: 'Buttonhole Machine BH-102',serialNumber: 'SN-BH-U1V2', type: 'Buttonhole Machine',location: 'Machine Bank', status: 'Bank',      lastMaintenanceDate: '2025-12-20', lastInspectionDate: '2026-01-30', usageHistory: 'In storage.',               imageUrl: 'https://picsum.photos/seed/BH-102/400/300' },
    { id: 'OL-104', name: 'Overlock Machine OL-104',  serialNumber: 'SN-OL-W3X4', type: 'Overlock Machine',  location: 'Machine Bank', status: 'Bank',      lastMaintenanceDate: '2025-11-10', lastInspectionDate: '2026-02-01', usageHistory: 'New unit, not deployed.',   imageUrl: 'https://picsum.photos/seed/OL-104/400/300' },
  ]);

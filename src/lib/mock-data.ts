...
export const MACHINES: Machine[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://picsum.photos/seed/overlock/400/300',
  },
  {
    id: 'MAC-005',
    name: 'High Post Specialist',
    serialNumber: 'HP-2211-E',
    type: 'High Post',
    location: 'Packaging Area',
    status: 'Operational',
    lastMaintenanceDate: '2025-01-05',
    lastInspectionDate: '2024-12-20',
    usageHistory: 'Vertical post for complex stitching.',
    imageUrl: 'https://picsum.photos/seed/highpost/400/300',
  },
  {
    id: 'MAC-006',
    name: 'Others Unit',
    serialNumber: 'OT-8822-Z',
    type: 'Others',
    location: 'Production Floor A',
    status: 'Operational',
    lastMaintenanceDate: '2025-01-10',
    lastInspectionDate: '2025-01-05',
    usageHistory: 'Miscellaneous machinery.',
    imageUrl: 'https://picsum.photos/seed/generic/400/300',
  }
];
